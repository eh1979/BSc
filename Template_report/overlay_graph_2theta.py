...
# Set x-axis limits (adjust min and max values as needed)
plt.xlim(30, 85)
plt.legend()
plt.grid(True)

# Save the plot of background-subtracted original unbinned data with Gaussians
fin_filename = '2theta_overlay.png'
fin_filepath = os.path.join(report_dir, "2theta/Graphs", fin_filename)
plt.savefig(fin_filepath)
print("Plot of overlay 2theta data saved as '2theta_overlay.png'")
