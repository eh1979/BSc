...
csv_filename = f"Sample_{sample_name}_2theta_guassian_table.csv"
csv_filepath = os.path.join(report_dir, "2theta/Tables", csv_filename)
...
background_subtracted_filepath = os.path.join(report_dir, "2theta/Tables", background_subtracted_filename)
